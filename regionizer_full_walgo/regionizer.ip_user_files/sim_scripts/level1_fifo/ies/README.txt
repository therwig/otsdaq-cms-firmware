...
#
# Generated by export_simulation on Wed May 08 23:31:39 CDT 2019
#
################################################################################
...
'-reset_run' switch to the './level1_fifo.sh' script.

./level1_fifo.sh -reset_run
...
./level1_fifo.sh -noclean_files

For more information on the script, please type './level1_fifo.sh -help'.
