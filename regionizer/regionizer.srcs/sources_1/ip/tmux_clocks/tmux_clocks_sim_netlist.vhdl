...
-- Date        : Mon Apr 22 12:11:55 2019
-- Host        : correlator2.fnal.gov running 64-bit Scientific Linux release 7.6 (Nitrogen)
-- Command     : write_vhdl -force -mode funcsim
--               /data/rrivera/CorrelatorTrigger/otsdaq-cms-firmware/regionizer/regionizer.srcs/sources_1/ip/tmux_clocks/tmux_clocks_sim_netlist.vhdl
-- Design      : tmux_clocks
...
entity tmux_clocks_tmux_clocks_clk_wiz is
  ...
  attribute ORIG_REF_NAME of tmux_clocks_tmux_clocks_clk_wiz : entity is "tmux_clocks_clk_wiz";
end tmux_clocks_tmux_clocks_clk_wiz;

architecture STRUCTURE of tmux_clocks_tmux_clocks_clk_wiz is
  signal clk_120_tmux_clocks : STD_LOGIC;
  signal clk_240_tmux_clocks : STD_LOGIC;
  signal clk_320_tmux_clocks : STD_LOGIC;
