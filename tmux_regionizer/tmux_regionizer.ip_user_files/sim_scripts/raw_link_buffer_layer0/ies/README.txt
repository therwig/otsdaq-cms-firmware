...
#
# Generated by export_simulation on Sun Apr 07 15:20:51 CDT 2019
#
################################################################################
...
'-reset_run' switch to the './raw_link_buffer_layer0.sh' script.

./raw_link_buffer_layer0.sh -reset_run
...
./raw_link_buffer_layer0.sh -noclean_files

For more information on the script, please type './raw_link_buffer_layer0.sh -help'.
